<?php $this->load->view('template/app/head'); ?>
  ...
  <div class="container">
    ...
    <div class="mainbar-collapse collapse">
      ...
      <ul class="nav navbar-nav mainbar-nav">
        ...
        <li class="dropdown ">
          <a href="page-blank.html#about" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
          ...
          <ul class="dropdown-menu">   
            ...
            <li class="dropdown-submenu">
              <a tabindex="-1" href="page-blank.html#">
        ...
        <li class="dropdown active">
          <a href="page-blank.html#contact" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown">
...
<?php $this->load->view('template/app/footer'); ?>
